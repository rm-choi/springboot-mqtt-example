...
public class CustomAdapter extends AbstractMqttMessageDrivenChannelAdapter<IMqttAsyncClient, MqttConnectOptions>
     ...
     */
    public CustomAdapter(String url, String clientId, String... topic) {
     ...
     * @param topic The topic(s).
     */
    public CustomAdapter(String url, String clientId, MqttPahoClientFactory clientFactory,
                                               String... topic) {
     ...
     * @since 4.1
     */
    public CustomAdapter(String clientId, MqttPahoClientFactory clientFactory,
                                               String... topic) {
     ...
     * @since 6.0
     */
    public CustomAdapter(ClientManager<IMqttAsyncClient, MqttConnectOptions> clientManager,
                                               String... topic) {
        ...
        if (builder != null) {
            if (isManualAcks()) {
                builder.setHeader(IntegrationMessageHeaderAccessor.ACKNOWLEDGMENT_CALLBACK,
                        new CustomAdapter.AcknowledgmentImpl(mqttMessage.getId(), mqttMessage.getQos(), this.client));
            }
